...
const CADSoftwarePage = () => {
  return <>
    ...
    <h3>Overview</h3>
    <FloatImage
      src="/assets/CADSoftware/main_window.webp"
      alt="Main window of the CAD software"
      float="left"
    />
    <p>
      An environment was developed for the display and navigation of existing Stereolithography (STL) files,
      with special emphasis on the ability to render a large quantity of independent actors without significant performance degradation.
      We were left with three different levels of detail for the same design: the university's Formula Student race car model.
    </p>
    <p>
    ...
    <CaptionedImageRow
      images={[
        { src: '/assets/CADSoftware/level0_component.webp', alt: "Low detail rendering", caption: "Rendering the parent only, Cooling (21-J-900-01_ASSY - COOLING.stl)" },
        { src: '/assets/CADSoftware/level2_component.webp', alt: "High detail rendering", caption: "Rendering all of Cooling's children instead of the parent" }
      ]}
      maxHeight={400}
    />
    <p>
    ...
    <FloatImage
      src="/assets/CADSoftware/pedal_selected.webp"
    ...
    <div className="clear" />
    <FloatImage
      src="/assets/CADSoftware/clip_filter.webp"
